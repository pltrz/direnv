...
`direnv export SHELL`
: Loads an .envrc or .env and prints the diff in terms of exports. Supported shells: bash, zsh, ysh, fish, tcsh, elvish, pwsh, murex, json, vim, gha (GitHub Actions), gzenv, systemd.
